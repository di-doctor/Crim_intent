...
//        }
    ...
    override fun onStart() {
        ...
        suspectButton.apply {
            ...
            setOnClickListener {
                Toast.makeText(context, "suspect_button pressed", Toast.LENGTH_LONG).show()
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        when {
            ...
            requestCode == REQUEST_CONTACT && data != null -> {
                ...
                val cContacts = ContactsContract.Contacts.DISPLAY_NAME
                val queryFields = arrayOf(cContacts)
